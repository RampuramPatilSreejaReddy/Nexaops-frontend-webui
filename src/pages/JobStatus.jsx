...
function GitHubPullRequestModal({ onClose }) {
  const pullRequestUrl = 'https://github.com/RampuramPatilSreejaReddy/Nexaops-frontend-webui/pulls'
  const [copied,setCopied] = useState(false)
