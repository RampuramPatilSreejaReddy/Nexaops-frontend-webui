...
const INTEGRATIONS = [
  { id: '01', name: 'GitHub Actions', detail: 'Repository & CI/CD workflow automation (nexaops-test-repo)', tag: 'Healthy', state: 'RampuramPatilSreejaReddy/nexaops-test-repo', age: 'Synced now', type: 'GitHub', source: 'https://github.com/RampuramPatilSreejaReddy/nexaops-test-repo' },
