...
const INTEGRATIONS = [
  { id: '01', name: 'GitHub Actions', detail: 'Repository & CI/CD workflow automation', tag: 'Healthy', state: 'RampuramPatilSreejaReddy/Nexaops-frontend-webui', age: 'Synced now', type: 'GitHub', source: 'https://github.com/RampuramPatilSreejaReddy/Nexaops-frontend-webui' },
...
function ConnectIntegrationModal({ onClose, onSave }) {
  const [form, setForm] = useState({
    ...
    auth: 'github_pat_11A_nexaops_webui_token'
  })
